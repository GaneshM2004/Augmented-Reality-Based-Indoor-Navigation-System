package com.example.tcenavigator.domain.di

import android.app.Application
import androidx.room.Room
import com.example.tcenavigator.data.data_source.Database
import com.example.tcenavigator.data.ml.classification.TextAnalyzer
import com.example.tcenavigator.data.pathfinding.AStarImpl
import com.example.tcenavigator.data.repository.GraphImpl
import com.example.tcenavigator.data.repository.RecordsImpl
import com.example.tcenavigator.domain.ml.ObjectDetector
import com.example.tcenavigator.domain.pathfinding.Pathfinder
import com.example.tcenavigator.domain.repository.GraphRepository
import com.example.tcenavigator.domain.tree.Tree
import com.example.tcenavigator.domain.use_cases.*
