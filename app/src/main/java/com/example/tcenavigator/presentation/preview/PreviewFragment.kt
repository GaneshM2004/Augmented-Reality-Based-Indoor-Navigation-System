...
import com.example.tcenavigator.databinding.FragmentPreviewBinding
import com.example.tcenavigator.domain.tree.TreeNode
import com.example.tcenavigator.domain.tree.WrongEntryException
import com.example.tcenavigator.presentation.LabelObject
import com.example.tcenavigator.presentation.common.helpers.DrawerHelper
import com.example.tcenavigator.presentation.preview.nodes_adapters.PathAdapter
import com.example.tcenavigator.presentation.preview.nodes_adapters.TreeAdapter
import com.example.tcenavigator.presentation.preview.state.PathState
...
class PreviewFragment : Fragment() {
    ...
    companion object {
        ...
        const val VIEWABLE_PATH_NODES = 100
        //distance of viewable nodes for admin mode
        const val VIEWABLE_ADMIN_NODES = 15f
